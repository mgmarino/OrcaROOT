// ORKatrinFLTEnergyHistogramDecoder.cc

#include "TROOT.h"
#include "ORKatrinFLTEnergyHistogramDecoder.hh"
#include "ORLogger.hh"

bool ORKatrinFLTEnergyHistogramDecoder::SetDataRecord(UInt_t* dataRecord) 
{
...
size_t ORKatrinFLTEnergyHistogramDecoder::CopyHistogramData(UInt_t* histogram, 
                                                     size_t len )
...
std::string ORKatrinFLTEnergyHistogramDecoder::GetParName(size_t iPar)
{
  switch(iPar) {
    case 0: return "crate";
    case 1: return "card";
...
UInt_t ORKatrinFLTEnergyHistogramDecoder::GetPar(UInt_t* record, size_t iPar, size_t /*iRow*/)
{
  switch(iPar) {
