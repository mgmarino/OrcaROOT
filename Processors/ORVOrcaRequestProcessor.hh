...
class ORVOrcaRequestProcessor 
{
  public:
    ...
    bool LoadInput(const std::string&, const std::string*, size_t = 0); 
    bool LoadInput(const std::string&, const int*, size_t = 0); 
    bool LoadInput(const std::string&, const double*, size_t = 0); 
  ...
  protected:
    ...
    // register the types of output the for which processor class is looking.  The
