...
ORIpeV4FLTEnergyTreeWriter::ORIpeV4FLTEnergyTreeWriter(string treeName) :
ORVTreeWriter(new ORIpeV4FLTEnergyDecoder, treeName)
{
  fEventDecoder = dynamic_cast<ORIpeV4FLTEnergyDecoder*>(fDataDecoder);
  Clear();
}

ORIpeV4FLTEnergyTreeWriter::~ORIpeV4FLTEnergyTreeWriter()
{
  delete fEventDecoder;
}

ORDataProcessor::EReturnCode ORIpeV4FLTEnergyTreeWriter::InitializeBranches()
{
...
ORDataProcessor::EReturnCode ORIpeV4FLTEnergyTreeWriter::ProcessMyDataRecord(UInt_t* record)
{
