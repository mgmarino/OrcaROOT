// OREdelweissSLTWaveformTreeWriter.cc
...
OREdelweissSLTWaveformTreeWriter::OREdelweissSLTWaveformTreeWriter(string treeName) :
ORVTreeWriter(new OREdelweissSLTWaveformDecoder, treeName)
{
  fEventDecoder = dynamic_cast<OREdelweissSLTWaveformDecoder*>(fDataDecoder);
  Clear();
  fWaveform[0] = 0;  // this is on the stack, not the heap.
}

OREdelweissSLTWaveformTreeWriter::~OREdelweissSLTWaveformTreeWriter()
{
...
/** Create the ROOT branches.
  * 
  */ //-tb- 2008-02-12
ORDataProcessor::EReturnCode OREdelweissSLTWaveformTreeWriter::InitializeBranches()
{
...
/**  This sets the data/variables for the ROOT branches.
  ...
  */ //-tb- 2008-02-12
ORDataProcessor::EReturnCode OREdelweissSLTWaveformTreeWriter::ProcessMyDataRecord(UInt_t* record)
{
